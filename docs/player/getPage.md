# Show All Data By Page

Memberikan player sesuai dengan parameter halaman dan batasan setiap halaman sesuai yang diminta yang diberikan. 

**URL** : `/api/v1/player/`

**URL Parameters** : `page=[integer]` dimana `page` adalah halaman dari player, apabila dikosongi maka nilai defaultnya adalah 1. `limit=[integer]` dimana `page` adalah jumlah setiap player pada setiap halaman, apabila dikosongi malah nilai defaultnya adalah 20. 
...
**Kondisi** : User dapat melihat player pada halaman tertentu dengan membatasi jumlah player yang diminta
